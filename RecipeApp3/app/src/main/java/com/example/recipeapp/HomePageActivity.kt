...
class HomePageActivity : AppCompatActivity() {
    ...
    var recipeAdapter = RecipeAdapter(this,recipe)
...
//      recipes
        ...
        binding.rvSubCategory.adapter = recipeAdapter
